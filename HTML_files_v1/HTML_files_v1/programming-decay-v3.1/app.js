...
const mlStages = [
  ...
  },
  {
    ...
    description: "Pix2Pix output is converted into NCA strategy zones, showing how generated patterns become stable remediation fields. / Pix2Pix 结果被转入 NCA 策略分区，说明生成图案如何变成稳定的修复场域。",
  },
  {
    label: "Stage 04",
...
const hubViews = [
  {
    ...
    copy: "The site plan connects remediation plots, sensing nodes, circulation, and the four-tower Hub into one deployable interface. / 总平面把修复地块、感测节点、公共动线和四塔 Hub 连接成一个可部署界面。",
    monitoring: false,
  },
  {
    id: "axon",
